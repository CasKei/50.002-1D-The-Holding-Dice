...
module au_top_0 (
  ...
  edge_detector_2 det_p2hold (
    .clk(clk),
    .in(M_det_p2hold_in),
    .out(M_det_p2hold_out)
  );
  wire [1-1:0] M_con_p1roll_out;
  reg [1-1:0] M_con_p1roll_in;
  button_conditioner_3 con_p1roll (
    .clk(clk),
    .in(M_con_p1roll_in),
    .out(M_con_p1roll_out)
  );
  wire [1-1:0] M_con_p1hold_out;
  reg [1-1:0] M_con_p1hold_in;
  button_conditioner_3 con_p1hold (
    .clk(clk),
    .in(M_con_p1hold_in),
    .out(M_con_p1hold_out)
  );
  wire [1-1:0] M_con_p2roll_out;
  reg [1-1:0] M_con_p2roll_in;
  button_conditioner_3 con_p2roll (
    .clk(clk),
    .in(M_con_p2roll_in),
    .out(M_con_p2roll_out)
  );
  wire [1-1:0] M_con_p2hold_out;
  reg [1-1:0] M_con_p2hold_in;
  button_conditioner_3 con_p2hold (
    .clk(clk),
    .in(M_con_p2hold_in),
    .out(M_con_p2hold_out)
  );
  ...
  reg [1-1:0] M_game_p1rollbutn;
  reg [1-1:0] M_game_p1holdbutn;
  reg [1-1:0] M_game_p2rollbutn;
  reg [1-1:0] M_game_p2holdbutn;
  gamebeta_4 game (
    .clk(clk),
    .rst(resetbutton),
    .p1rollbutn(M_game_p1rollbutn),
    .p1holdbutn(M_game_p1holdbutn),
    .p2rollbutn(M_game_p2rollbutn),
    .p2holdbutn(M_game_p2holdbutn),
  ...
  display_player_score_6 display_p1curr (
    .clk(clk),
    .rst(resetbutton),
  ...
  display_player_score_6 display_p1acc (
    .clk(clk),
    .rst(resetbutton),
  ...
  display_player_score_6 display_p2curr (
    .clk(clk),
    .rst(resetbutton),
  ...
  display_player_score_6 display_p2acc (
    .clk(clk),
    .rst(resetbutton),
  ...
  always @* begin
    ...
    rst = M_reset_cond_out;
    M_con_p1roll_in = p1rollbutton;
    M_con_p1hold_in = p1holdbutton;
    M_con_p2roll_in = p2rollbutton;
    M_con_p2hold_in = p2holdbutton;
    M_det_p1roll_in = M_con_p1roll_out;
    M_det_p1hold_in = M_con_p1hold_out;
    M_det_p2roll_in = M_con_p2roll_out;
    M_det_p2hold_in = M_con_p2hold_out;
    M_game_p1rollbutn = M_det_p1roll_out;
    M_game_p1holdbutn = M_det_p1hold_out;
    M_game_p2rollbutn = M_det_p2roll_out;
    M_game_p2holdbutn = M_det_p2hold_out;
